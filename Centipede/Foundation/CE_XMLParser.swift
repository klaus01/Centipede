...
public extension XMLParser {
    ...
    public func ce_parserDidStartDocument(handle: ((XMLParser) -> Void)) -> Self {
        ce._parserDidStartDocument = handle
        rebindingDelegate()
        return self
    }
    public func ce_parserDidEndDocument(handle: ((XMLParser) -> Void)) -> Self {
    ...
    public func ce_parser_foundUnparsedEntityDeclarationWithName(handle: ((XMLParser, String, String?, String?, String?) -> Void)) -> Self {
        ce._parser_foundUnparsedEntityDeclarationWithName = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundAttributeDeclarationWithName(handle: ((XMLParser, String, String, String?, String?) -> Void)) -> Self {
        ce._parser_foundAttributeDeclarationWithName = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundElementDeclarationWithName(handle: ((XMLParser, String, String) -> Void)) -> Self {
        ce._parser_foundElementDeclarationWithName = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundInternalEntityDeclarationWithName(handle: ((XMLParser, String, String?) -> Void)) -> Self {
        ce._parser_foundInternalEntityDeclarationWithName = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundExternalEntityDeclarationWithName(handle: ((XMLParser, String, String?, String?) -> Void)) -> Self {
        ce._parser_foundExternalEntityDeclarationWithName = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_didStartElement(handle: ((XMLParser, String, String?, String?, [String : String]) -> Void)) -> Self {
        ce._parser_didStartElement = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_didEndElement(handle: ((XMLParser, String, String?, String?) -> Void)) -> Self {
        ce._parser_didEndElement = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_didStartMappingPrefix(handle: ((XMLParser, String, String) -> Void)) -> Self {
        ce._parser_didStartMappingPrefix = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_didEndMappingPrefix(handle: ((XMLParser, String) -> Void)) -> Self {
        ce._parser_didEndMappingPrefix = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundCharacters(handle: ((XMLParser, String) -> Void)) -> Self {
        ce._parser_foundCharacters = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundIgnorableWhitespace(handle: ((XMLParser, String) -> Void)) -> Self {
        ce._parser_foundIgnorableWhitespace = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundProcessingInstructionWithTarget(handle: ((XMLParser, String, String?) -> Void)) -> Self {
        ce._parser_foundProcessingInstructionWithTarget = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundComment(handle: ((XMLParser, String) -> Void)) -> Self {
        ce._parser_foundComment = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_foundCDATA(handle: ((XMLParser, Data) -> Void)) -> Self {
        ce._parser_foundCDATA = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_resolveExternalEntityName(handle: ((XMLParser, String, String?) -> Data?)) -> Self {
        ce._parser_resolveExternalEntityName = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_parseErrorOccurred(handle: ((XMLParser, Error) -> Void)) -> Self {
        ce._parser_parseErrorOccurred = handle
        rebindingDelegate()
        return self
    }
    public func ce_parser_validationErrorOccurred(handle: ((XMLParser, Error) -> Void)) -> Self {
