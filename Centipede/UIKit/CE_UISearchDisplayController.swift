...
public extension UISearchDisplayController {
    ...
    private var _delegate: UISearchDisplayController_Delegate? {
        get { return objc_getAssociatedObject(self, &Static.AssociationKey) as? UISearchDisplayController_Delegate }
    ...
    private var ce: UISearchDisplayController_Delegate {
        ...
        if let obj = self.delegate {
            if obj is UISearchDisplayController_Delegate {
                return obj as! UISearchDisplayController_Delegate
            }
        }
